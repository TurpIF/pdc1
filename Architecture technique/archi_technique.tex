...
les serveurs applicatifs, pour réduire la latence due à l'accès au sous-système
...
spécifiquement pour contrôler l'accès et donc empêcher le trafic intempestif.
